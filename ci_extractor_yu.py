    ...
    def run(self):
        while True:
            try:
                ...
                self.cur.execute("select context, description, target_url from selected_pr_statuses where project_id=%s and github_id=%s", (project_id, github_id))
...
if __name__ == "__main__": 
    ...
    cur.execute("select distinct sps.project_id, sps.github_id from selected_pr_statuses sps")
